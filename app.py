...
popular_df = pickle.load(open('popular.pkl', 'rb'))            # Popular books DataFrame
pt = pickle.load(open('pt.pkl', 'rb'))                          # Pivot table (book-user matrix)
...
def get_recommendations(book_name):
    """
    Function to recommend similar books based on book name
    Returns a list of recommended books with their details
    """
